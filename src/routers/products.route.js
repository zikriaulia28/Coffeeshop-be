...
productsRouter.post("/", checkToken, checkRole, memoryUpload("image"), productsController.insertProducts);
// Read
...
productsRouter.patch("/:id", checkToken, checkRole, memoryUpload("image"), productsController.updateProducts);
// Delete
